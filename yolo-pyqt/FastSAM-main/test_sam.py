...
def main(args):
    ...
    while True:
        ...
        points = None
        point_label = None
        box_prompt = [[100,100,200,200],[300,300,400,400],[400,400,500,500],[600,600,700,700],[800,800,900,900]]
        ...
        result = prompt_process.fastplot(
            annotations=ann,
